...
export class MarcasService {
    ...
    marcas(search?: string): Observable<Marca[]> {
      ...
      return this.http.get<Marca[]>(`${MEAT_API}/marcas`, {params: params})
    }

    marcaById(id: string): Observable<Marca> {
      return this.http.get<Marca>(`${MEAT_API}/marcas/${id}`)
    }

    reviewsOfMarca(id: string): Observable<any> {
      return this.http.get(`${MEAT_API}/marcas/${id}/reviews`)
    }

    menuOfMarca(id: string): Observable<MenuItem[]> {
      return this.http.get<MenuItem[]>(`${MEAT_API}/marcas/${id}/menu`)
    }
